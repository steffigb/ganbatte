...
export function learningItemFromRemote(row: RemoteRow): LearningItem {
  ...
  return {
    ...
    formation: optionalString(row.formation),
    partOfSpeech: row.part_of_speech as LearningItem['partOfSpeech'],
    verbType: row.verb_type as LearningItem['verbType'],
    transitivity: row.transitivity as LearningItem['transitivity'],
    pairedItemId: optionalString(row.paired_item_id),
    notes: optionalString(row.notes),
    onyomi,
...
export function learningItemToRemote(item: LearningItem): RemoteRow {
  return {
    ...
    verb_type: item.verbType ?? null,
    transitivity: item.transitivity ?? null,
    paired_item_id: item.pairedItemId ?? null,
